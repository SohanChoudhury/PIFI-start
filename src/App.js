...
class App extends Component {
    ...
    createMenu() {
        this.menu = [
            ...
            {
                label: 'Sources', icon: 'pi pi-fw pi-globe', badge: '5',
                items: [
                    {label: 'Robinhood', icon: 'pi pi-fw pi-search', command: () => {window.location = '#/sample'}},
                    {label: 'TD Ameritrade', icon: 'pi pi-fw pi-search', command: () => {window.location = '#/forms'}},
                    {label: 'Wells Fargo', icon: 'pi pi-fw pi-search', command: () => {window.location = "#/data"}},
                    {label: 'Coinbase', icon: 'pi pi-fw pi-search', command: () => {window.location = "#/panels"}},
                    {label: 'Cash', icon: 'pi pi-fw pi-search', command: () => {window.location = "#/overlays"}}
                ]
            },
            {
