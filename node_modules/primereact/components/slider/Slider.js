...
var Slider = exports.Slider = function (_Component) {
    ...
    _createClass(Slider, [{
        ...
        value: function render() {
            ...
            var verticalRange = this.props.orientation === 'vertical' && _react2.default.createElement('span', { className: 'p-slider-range p-slider-range-min', style: { 'height': this.handleValue + '%' } });
            if (this.props.range) {
                var leftHandleClass = (0, _classnames2.default)('p-slider-handle', {
                    'p-slider-handle-active': this.props.handleIndex === 0
                }),
                    rightHandleClass = (0, _classnames2.default)('p-slider-handle', {
                    'p-slider-handle-active': this.props.handleIndex === 1
                });

                var middleRange = _react2.default.createElement('span', { className: 'p-slider-range', style: { 'left': this.handleValues[0] + '%', width: this.handleValues[1] - this.handleValues[0] + '%' } });
                ...
                var handle = _react2.default.createElement('span', { className: 'p-slider-handle', onMouseDown: this.onMouseDown, onTouchStart: this.onTouchStart, onTouchMove: this.onTouchMove,
